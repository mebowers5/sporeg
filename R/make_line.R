#' Make a line
#' Create a line by connecting start and end points
#' 
...
#' make_line(sf::st_coordinates(point_geom)[,1], sf::st_coordinates(point_geom)[,2], lead(sf::st_coordinates(point_geom)[,1]), lead(sf::st_coordinates(point_geom)[,2]))
#' @export
