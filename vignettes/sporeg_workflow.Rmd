...
#> Ncells  4899571 261.7   16144236  862.2  20020541 1069.3
#> Vcells 13242971 101.1  142066286 1083.9 346841131 2646.2
```
...
gc()
#>            used  (Mb) gc trigger   (Mb)  max used   (Mb)
#> Ncells  5937806 317.2   16144236  862.2  20020541 1069.3
#> Vcells 86773773 662.1  277306084 2115.7 346841131 2646.2
```
...
#>   2.243987   2.237338   3.867154   3.884465
```
...
#> Response: g_fit
#>            LR Chisq Df Pr(>Chisq)  
#> p_a          4.1599  1    0.04139 *
#> mean_depth   1.0366  1    0.30862  
#> ---
...
#> Response: g_fit
#>            LR Chisq Df Pr(>Chisq)  
#> den_rcs      3.9681  1    0.04637 *
#> p_a          4.8087  1    0.02832 *
#> mean_depth   4.6879  1    0.03038 *
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
#> Response: g_fit
#>            LR Chisq Df Pr(>Chisq)  
#> den_rcs      2.6686  1    0.10235  
#> p_a          3.9961  1    0.04561 *
#> mean_depth   6.4064  1    0.01137 *
#> d_shore      0.0083  1    0.92754  
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
#> Coefficients:
#>               Estimate Std. Error z value Pr(>|z|)
#> (Intercept)  -20.83643 2790.65303  -0.007    0.994
#> p_a1          18.19835 2790.65301   0.007    0.995
#> mean_depth    -0.05813    0.08522  -0.682    0.495
#> 
#> (Dispersion parameter for binomial family taken to be 1)
#> 
#>     Null deviance: 23.837  on 285  degrees of freedom
#> Residual deviance: 17.353  on 283  degrees of freedom
...
#> Coefficients:
#>               Estimate Std. Error z value Pr(>|z|)    
#> (Intercept)   -4.34384    0.63747  -6.814 9.48e-12 ***
#> den_rcs     -157.33129  135.99644  -1.157   0.2473    
#> p_a1           2.38492    1.03498   2.304   0.0212 *  
#> mean_depth    -0.03038    0.02401  -1.266   0.2057    
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#> (Dispersion parameter for binomial family taken to be 1)
#> 
#>     Null deviance: 82.96  on 967  degrees of freedom
#> Residual deviance: 72.32  on 964  degrees of freedom
...
#> Coefficients:
#>               Estimate Std. Error z value Pr(>|z|)    
#> (Intercept) -4.373e+00  2.928e-01 -14.931   <2e-16 ***
#> den_rcs     -2.563e+01  2.301e+01  -1.114    0.265    
#> p_a1         1.531e+00  7.455e-01   2.054    0.040 *  
#> mean_depth  -3.199e-02  2.149e-02  -1.489    0.137    
#> d_shore      1.029e-06  1.134e-05   0.091    0.928    
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#> (Dispersion parameter for binomial family taken to be 1)
#> 
#>     Null deviance: 348.39  on 5198  degrees of freedom
#> Residual deviance: 321.98  on 5194  degrees of freedom
